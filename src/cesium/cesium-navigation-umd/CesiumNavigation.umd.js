(function (global, factory) {
	...
	var require$$1$2 = ( _redefine$1 && _redefine ) || _redefine$1;
	...
	var $export = function (type, name, source) {
	  ...
	  for (key in source) {
	    ...
	    // extend global
	    if (target) require$$1$2(target, key, out, type & $export.U);
	    // export
	...
	$export$1($export$1.S + $export$1.F * !require$$1, 'Object', { defineProperties: dPs });
	...
	var require$$0$6 = ( _wks$1 && _wks ) || _wks$1;

	// getting tag from 19.1.3.6 Object.prototype.toString()

	var TAG = require$$0$6('toStringTag');
	// ES3 wrong here
	...
	var test = {};
	test[require$$0$6('toStringTag')] = 'z';
	if (test + '' != '[object z]') {
	...
	var DistanceLegendViewModel = function DistanceLegendViewModel(options) {
	  if (!defined$1(options) || !defined$1(options.terria)) {
	  ...
	  this.enableDistanceLegend = defined$1(options.enableDistanceLegend) ? options.enableDistanceLegend : true;
	  Knockout$1.track(this, ['distanceLabel', 'barWidth']);
	  this.eventHelper.add(this.terria.afterWidgetChanged, function () {
	    if (defined$1(this._removeSubscription)) {
	...
	function updateDistanceLegendCesium(viewModel, scene) {
	  ...
	  if (!defined$1(leftPosition) || !defined$1(rightPosition)) {
	    viewModel.barWidth = undefined;
	    viewModel.distanceLabel = undefined;
	    return;
	  }
	  ...
	  for (var i = distances.length - 1; !defined$1(distance) && i >= 0; --i) {
	    if (distances[i] / pixelDistance < maxBarWidth) {
	      distance = distances[i];
	    }
	  }

	  if (defined$1(distance)) {
	    var label;
	...
	var defined$7 = Cesium.defined; // var definedProperties = Cesium.defineProperties || Object.defineProperties
